...
class Seo
{
    ...
    {
        return self::make(
            title: $post->seo_title ?? (string) $post->title,
            description: $post->meta_description ?? $post->excerpt,
            canonical: $post->canonical_url ?? route('public.posts.show', $post->slug),
    ...
    {
        return $post->og_image_path === null ? null : Storage::disk('public')->url($post->og_image_path);
    }
